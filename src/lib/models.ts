 ...
 */
export function getModelProvider(modelIdentifier: SupportedModel): LanguageModel {
  ...
  switch (platform) {
    ...
    default:
      console.warn(`Unsupported model platform: ${platform}. Defaulting to gemini-1.5-flash-latest.`);
